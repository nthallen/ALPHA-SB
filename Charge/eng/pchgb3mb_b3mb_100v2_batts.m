function pchgb3mb_b3mb_100v2_batts(varargin);
% pchgb3mb_b3mb_100v2_batts( [...] );
% B3MB 100V2 Batt Status
h = ne_dstat({
  'B3MB_100V2_B1S', 'B3MB_100V2_Cmd_S', 0; ...
	'B3MB_100V2_B2S', 'B3MB_100V2_Cmd_S', 1; ...
	'B3MB_100V2_B3S', 'B3MB_100V2_Cmd_S', 2; ...
	'B3MB_100V2_B4S', 'B3MB_100V2_Cmd_S', 3; ...
