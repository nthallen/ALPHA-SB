...
dfs.plot('micm', 'label', 'ICM', 'plots', {'micmm','micmr'});
dfs.plot('micmm','label','Max','vars',{'ICM_max_g'});
dfs.plot('micmr','label','Rate','vars',{'ICM_sps'});
dfs.end_col;
dfs.start_col;
dfs.plot('micmhk', 'label', 'ICM HK', 'plots', {'micmhkmlf','micmhkm','micmhkr','micmhkremainder','micmhkmsecs','micmhks','micmhkstale'});
dfs.plot('micmhkmlf','label','MLF','vars',{'ICM_mlf'});
dfs.plot('micmhkm','label','Mode','vars',{'ICM_mode'});
dfs.plot('micmhkr','label','Rate','vars',{'ICM_sps'});
dfs.plot('micmhkremainder','label','Remainder','vars',{'ICM_rem0','ICM_rem1'});
dfs.plot('micmhkmsecs','label','msecs','vars',{'ICM_msecs'});
dfs.plot('micmhks','label','Scale','vars',{'ICM_fs'});
dfs.plot('micmhkstale','label','Stale','vars',{'ICM_stale'});
dfs.plot('micmp', 'label', 'ICM Peaks', 'plots', {'micmpf','micmpa'});
dfs.plot('micmpf','label','Freq','vars',{'ICM_peak_f_0_0','ICM_peak_f_0_1','ICM_peak_f_0_2'});
dfs.plot('micmpa','label','Amp','vars',{'ICM_peak_amp_0_0','ICM_peak_amp_0_1','ICM_peak_amp_0_2'});
dfs.end_col;
dfs.start_col;
...
dfs.plot('b3mb28_b3mb_28v3_batttv','label','Temp 28V3','vars',{'B3MB_28V3_T1','B3MB_28V3_T2','B3MB_28V3_T3','B3MB_28V3_T4','B3MB_28V3_T5'});
