...
dfs.end_col;
dfs.start_col;
dfs.plot('micmhk', 'label', 'ICM HK', 'plots', {'micmhkmlf','micmhkm','micmhkr','micmhkremainder','micmhkmsecs','micmhks','micmhkstatus','micmhkstale'});
...
dfs.plot('micmhks','label','Scale','vars',{'ICM_fsc'});
dfs.plot('micmhkstatus','label','Status','vars',{{'name','ICM_nack','var_name','ICM_fs','bit_number',2}});
