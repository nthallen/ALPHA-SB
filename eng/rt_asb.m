...
dfs.end_col;
dfs.start_col;
dfs.plot('mgnsshk', 'label', 'GNSS HK', 'plots', {'mgnsshks','mgnsshkf','mgnsshkd','mgnsshkdrift','mgnsshkstd','mgnsshkstale'});
...
dfs.plot('mgnsshkd','label','Dual','vars',{{'name','dual_heading_active','var_name','filter_status','bit_number',10}});
dfs.plot('mgnsshkdrift','label','Drift','vars',{'nav_drift'});
...
dfs.plot('mdacs', 'label', 'uDACS', 'plots', {'mdacsmg','mdacsr'});
...
dfs.plot('mpmcl', 'label', 'PMC Left', 'plots', {'mpmclrpm','mpmclc','mpmclv','mpmclp','mpmclt'});
...
dfs.plot('mpmclt','label','Temp','vars',{'uDport_T1','uDport_T2'});
dfs.end_col;
dfs.start_col;
...
dfs.end_col;
dfs.start_col;
dfs.plot('mpmcr', 'label', 'PMC Right', 'plots', {'mpmcrrpm','mpmcrc','mpmcrv','mpmcrp','mpmcrt'});
...
dfs.plot('mpmcrt','label','Temp','vars',{'uDstbd_T1','uDstbd_T2'});
dfs.end_col;
dfs.start_col;
