function dfs_out = rt_scopex2(dfs)
% dfs = rt_scopex()
...
dfs.start_tab('Cmd');
dfs.start_col;
dfs.plot('cc', 'label', 'Cmd', 'plots', {'cccsn','cccd'});
dfs.plot('cccsn','label','Cmd SN','vars',{'Cmd_SN'});
dfs.plot('cccd','label','Cmd Dups','vars',{'Cmd_Dups'});
dfs.end_tab;
...
dfs.end_col;
dfs.start_col;
dfs.plot('b3mb_b3mb_28v3_batt', 'label', 'B3MB 28V3 Batt', 'plots', {'b3mb_b3mb_28v3_battvv','b3mb_b3mb_28v3_battav','b3mb_b3mb_28v3_batttv','b3mb_b3mb_28v3_batts','b3mb_b3mb_28v3_battf'});
dfs.plot('b3mb_b3mb_28v3_battvv','label','Volts 28V3','vars',{'B3MB_28V3_Batt1_V','B3MB_28V3_Batt2_V','B3MB_28V3_Batt3_V','B3MB_28V3_Batt4_V','B3MB_28V3_Bus_V'});
dfs.plot('b3mb_b3mb_28v3_battav','label','Amps 28V3','vars',{'B3MB_28V3_Batt1_I','B3MB_28V3_Batt2_I','B3MB_28V3_Batt3_I','B3MB_28V3_Batt4_I'});
dfs.plot('b3mb_b3mb_28v3_batttv','label','Temp 28V3','vars',{'B3MB_28V3_T1','B3MB_28V3_T2','B3MB_28V3_T3','B3MB_28V3_T4'});
dfs.plot('b3mb_b3mb_28v3_batts','label','Status','vars',{{'name','B3MB_28V3_B1S','var_name','B3MB_28V3_Cmd_S','bit_number',0},{'name','B3MB_28V3_B2S','var_name','B3MB_28V3_Cmd_S','bit_number',1},{'name','B3MB_28V3_B3S','var_name','B3MB_28V3_Cmd_S','bit_number',2},{'name','B3MB_28V3_B4S','var_name','B3MB_28V3_Cmd_S','bit_number',3},{'name','B3MB_28V3_Stat_LED','var_name','B3MB_28V3_LED_S','bit_number',0},{'name','B3MB_28V3_Fault_LED','var_name','B3MB_28V3_LED_S','bit_number',1},{'name','B3MB_28V3_ID_CPU','var_name','B3MB_28V3_LED_S','bit_number',2}});
dfs.plot('b3mb_b3mb_28v3_battf','label','Fault','vars',{{'name','B3MB_28V3_B1F','var_name','B3MB_28V3_Cmd_S','bit_number',8},{'name','B3MB_28V3_B2F','var_name','B3MB_28V3_Cmd_S','bit_number',9},{'name','B3MB_28V3_B3F','var_name','B3MB_28V3_Cmd_S','bit_number',10},{'name','B3MB_28V3_B4F','var_name','B3MB_28V3_Cmd_S','bit_number',11}});
dfs.plot('b3mb_b3mb_28v3_load', 'label', 'B3MB 28V3 Load', 'plots', {'b3mb_b3mb_28v3_loadvv','b3mb_b3mb_28v3_loadav','b3mb_b3mb_28v3_loads','b3mb_b3mb_28v3_loadf'});
dfs.plot('b3mb_b3mb_28v3_loadvv','label','Volts 28V3','vars',{'B3MB_28V3_Load1_V','B3MB_28V3_Load2_V','B3MB_28V3_Load3_V','B3MB_28V3_Load4_V'});
dfs.plot('b3mb_b3mb_28v3_loadav','label','Amps 28V3','vars',{'B3MB_28V3_Load1_I','B3MB_28V3_Load2_I','B3MB_28V3_Load3_I','B3MB_28V3_Load4_I'});
dfs.plot('b3mb_b3mb_28v3_loads','label','Status','vars',{{'name','B3MB_28V3_Load1S','var_name','B3MB_28V3_Cmd_S','bit_number',4},{'name','B3MB_28V3_Load2S','var_name','B3MB_28V3_Cmd_S','bit_number',5},{'name','B3MB_28V3_Load3S','var_name','B3MB_28V3_Cmd_S','bit_number',6},{'name','B3MB_28V3_Load4S','var_name','B3MB_28V3_Cmd_S','bit_number',7}});
dfs.plot('b3mb_b3mb_28v3_loadf','label','Fault','vars',{{'name','B3MB_28V3_Load1F','var_name','B3MB_28V3_Cmd_S','bit_number',12},{'name','B3MB_28V3_Load2F','var_name','B3MB_28V3_Cmd_S','bit_number',13},{'name','B3MB_28V3_Load3F','var_name','B3MB_28V3_Cmd_S','bit_number',14},{'name','B3MB_28V3_Load4F','var_name','B3MB_28V3_Cmd_S','bit_number',15}});
dfs.end_col;
dfs.start_col;
...
dfs.plot('b3mb_b3mb_100v1_batttv','label','Temp 100V1','vars',{'B3MB_100V1_T1','B3MB_100V1_T2','B3MB_100V1_T3','B3MB_100V1_T4'});
...
dfs.plot('b3mb_b3mb_100v2_batttv','label','Temp 100V2','vars',{'B3MB_100V2_T1','B3MB_100V2_T2','B3MB_100V2_T3','B3MB_100V2_T4'});
...
dfs.plot('b3mb_b3mb_100v3_batttv','label','Temp 100V3','vars',{'B3MB_100V3_T1','B3MB_100V3_T2','B3MB_100V3_T3','B3MB_100V3_T4'});
...
dfs.plot('b3mb_b3mb_100v4_batttv','label','Temp 100V4','vars',{'B3MB_100V4_T1','B3MB_100V4_T2','B3MB_100V4_T3','B3MB_100V4_T4'});
...
dfs.end_col;
dfs.start_col;
dfs.plot('b3mb_b3mb_100v5_batt', 'label', 'B3MB 100V5 Batt', 'plots', {'b3mb_b3mb_100v5_battvv','b3mb_b3mb_100v5_battav','b3mb_b3mb_100v5_batttv','b3mb_b3mb_100v5_batts','b3mb_b3mb_100v5_battf'});
dfs.plot('b3mb_b3mb_100v5_battvv','label','Volts 100V5','vars',{'B3MB_100V5_Batt1_V','B3MB_100V5_Bus_V'});
dfs.plot('b3mb_b3mb_100v5_battav','label','Amps 100V5','vars',{'B3MB_100V5_Batt1_I'});
dfs.plot('b3mb_b3mb_100v5_batttv','label','Temp 100V5','vars',{'B3MB_100V5_T2'});
dfs.plot('b3mb_b3mb_100v5_batts','label','Status','vars',{{'name','B3MB_100V5_B1S','var_name','B3MB_100V5_Cmd_S','bit_number',0},{'name','B3MB_100V5_Stat_LED','var_name','B3MB_100V5_LED_S','bit_number',0},{'name','B3MB_100V5_Fault_LED','var_name','B3MB_100V5_LED_S','bit_number',1},{'name','B3MB_100V5_ID_CPU','var_name','B3MB_100V5_LED_S','bit_number',2}});
dfs.plot('b3mb_b3mb_100v5_battf','label','Fault','vars',{{'name','B3MB_100V5_B1F','var_name','B3MB_100V5_Cmd_S','bit_number',8}});
dfs.plot('b3mb_b3mb_100v5_load', 'label', 'B3MB 100V5 Load', 'plots', {'b3mb_b3mb_100v5_loadvv','b3mb_b3mb_100v5_loadav','b3mb_b3mb_100v5_loads','b3mb_b3mb_100v5_loadf'});
dfs.plot('b3mb_b3mb_100v5_loadvv','label','Volts 100V5','vars',{'B3MB_100V5_Load1_V','B3MB_100V5_Load2_V','B3MB_100V5_Load3_V','B3MB_100V5_Load4_V'});
dfs.plot('b3mb_b3mb_100v5_loadav','label','Amps 100V5','vars',{'B3MB_100V5_Load1_I','B3MB_100V5_Load2_I','B3MB_100V5_Load3_I','B3MB_100V5_Load4_I'});
dfs.plot('b3mb_b3mb_100v5_loads','label','Status','vars',{{'name','B3MB_100V5_Load1S','var_name','B3MB_100V5_Cmd_S','bit_number',4},{'name','B3MB_100V5_Load2S','var_name','B3MB_100V5_Cmd_S','bit_number',5},{'name','B3MB_100V5_Load3S','var_name','B3MB_100V5_Cmd_S','bit_number',6},{'name','B3MB_100V5_Load4S','var_name','B3MB_100V5_Cmd_S','bit_number',7}});
dfs.plot('b3mb_b3mb_100v5_loadf','label','Fault','vars',{{'name','B3MB_100V5_Load1F','var_name','B3MB_100V5_Cmd_S','bit_number',12},{'name','B3MB_100V5_Load2F','var_name','B3MB_100V5_Cmd_S','bit_number',13},{'name','B3MB_100V5_Load3F','var_name','B3MB_100V5_Cmd_S','bit_number',14},{'name','B3MB_100V5_Load4F','var_name','B3MB_100V5_Cmd_S','bit_number',15}});
dfs.end_col;
dfs.start_col;
dfs.plot('b3mb_b3mb_100v6_batt', 'label', 'B3MB 100V6 Batt', 'plots', {'b3mb_b3mb_100v6_battvv','b3mb_b3mb_100v6_battav','b3mb_b3mb_100v6_batttv','b3mb_b3mb_100v6_batts','b3mb_b3mb_100v6_battf'});
dfs.plot('b3mb_b3mb_100v6_battvv','label','Volts 100V6','vars',{'B3MB_100V6_Batt1_V','B3MB_100V6_Bus_V'});
dfs.plot('b3mb_b3mb_100v6_battav','label','Amps 100V6','vars',{'B3MB_100V6_Batt1_I'});
dfs.plot('b3mb_b3mb_100v6_batttv','label','Temp 100V6','vars',{'B3MB_100V6_T1'});
dfs.plot('b3mb_b3mb_100v6_batts','label','Status','vars',{{'name','B3MB_100V6_B1S','var_name','B3MB_100V6_Cmd_S','bit_number',0},{'name','B3MB_100V6_Stat_LED','var_name','B3MB_100V6_LED_S','bit_number',0},{'name','B3MB_100V6_Fault_LED','var_name','B3MB_100V6_LED_S','bit_number',1},{'name','B3MB_100V6_ID_CPU','var_name','B3MB_100V6_LED_S','bit_number',2}});
dfs.plot('b3mb_b3mb_100v6_battf','label','Fault','vars',{{'name','B3MB_100V6_B1F','var_name','B3MB_100V6_Cmd_S','bit_number',8}});
dfs.plot('b3mb_b3mb_100v6_load', 'label', 'B3MB 100V6 Load', 'plots', {'b3mb_b3mb_100v6_loadvv','b3mb_b3mb_100v6_loadav','b3mb_b3mb_100v6_loads','b3mb_b3mb_100v6_loadf'});
dfs.plot('b3mb_b3mb_100v6_loadvv','label','Volts 100V6','vars',{'B3MB_100V6_Load1_V','B3MB_100V6_Load2_V','B3MB_100V6_Load3_V','B3MB_100V6_Load4_V'});
dfs.plot('b3mb_b3mb_100v6_loadav','label','Amps 100V6','vars',{'B3MB_100V6_Load1_I','B3MB_100V6_Load2_I','B3MB_100V6_Load3_I','B3MB_100V6_Load4_I'});
dfs.plot('b3mb_b3mb_100v6_loads','label','Status','vars',{{'name','B3MB_100V6_Load1S','var_name','B3MB_100V6_Cmd_S','bit_number',4},{'name','B3MB_100V6_Load2S','var_name','B3MB_100V6_Cmd_S','bit_number',5},{'name','B3MB_100V6_Load3S','var_name','B3MB_100V6_Cmd_S','bit_number',6},{'name','B3MB_100V6_Load4S','var_name','B3MB_100V6_Cmd_S','bit_number',7}});
dfs.plot('b3mb_b3mb_100v6_loadf','label','Fault','vars',{{'name','B3MB_100V6_Load1F','var_name','B3MB_100V6_Cmd_S','bit_number',12},{'name','B3MB_100V6_Load2F','var_name','B3MB_100V6_Cmd_S','bit_number',13},{'name','B3MB_100V6_Load3F','var_name','B3MB_100V6_Cmd_S','bit_number',14},{'name','B3MB_100V6_Load4F','var_name','B3MB_100V6_Cmd_S','bit_number',15}});
dfs.end_col;
dfs.start_col;
dfs.plot('b3mb_b3mb_100v7_batt', 'label', 'B3MB 100V7 Batt', 'plots', {'b3mb_b3mb_100v7_battvv','b3mb_b3mb_100v7_battav','b3mb_b3mb_100v7_batttv','b3mb_b3mb_100v7_batts','b3mb_b3mb_100v7_battf'});
dfs.plot('b3mb_b3mb_100v7_battvv','label','Volts 100V7','vars',{'B3MB_100V7_Batt1_V','B3MB_100V7_Bus_V'});
dfs.plot('b3mb_b3mb_100v7_battav','label','Amps 100V7','vars',{'B3MB_100V7_Batt1_I'});
dfs.plot('b3mb_b3mb_100v7_batttv','label','Temp 100V7','vars',{'B3MB_100V7_T1'});
dfs.plot('b3mb_b3mb_100v7_batts','label','Status','vars',{{'name','B3MB_100V7_B1S','var_name','B3MB_100V7_Cmd_S','bit_number',0},{'name','B3MB_100V7_Stat_LED','var_name','B3MB_100V7_LED_S','bit_number',0},{'name','B3MB_100V7_Fault_LED','var_name','B3MB_100V7_LED_S','bit_number',1},{'name','B3MB_100V7_ID_CPU','var_name','B3MB_100V7_LED_S','bit_number',2}});
dfs.plot('b3mb_b3mb_100v7_battf','label','Fault','vars',{{'name','B3MB_100V7_B1F','var_name','B3MB_100V7_Cmd_S','bit_number',8}});
dfs.plot('b3mb_b3mb_100v7_load', 'label', 'B3MB 100V7 Load', 'plots', {'b3mb_b3mb_100v7_loadvv','b3mb_b3mb_100v7_loadav','b3mb_b3mb_100v7_loads','b3mb_b3mb_100v7_loadf'});
dfs.plot('b3mb_b3mb_100v7_loadvv','label','Volts 100V7','vars',{'B3MB_100V7_Load1_V','B3MB_100V7_Load2_V','B3MB_100V7_Load3_V','B3MB_100V7_Load4_V'});
dfs.plot('b3mb_b3mb_100v7_loadav','label','Amps 100V7','vars',{'B3MB_100V7_Load1_I','B3MB_100V7_Load2_I','B3MB_100V7_Load3_I','B3MB_100V7_Load4_I'});
dfs.plot('b3mb_b3mb_100v7_loads','label','Status','vars',{{'name','B3MB_100V7_Load1S','var_name','B3MB_100V7_Cmd_S','bit_number',4},{'name','B3MB_100V7_Load2S','var_name','B3MB_100V7_Cmd_S','bit_number',5},{'name','B3MB_100V7_Load3S','var_name','B3MB_100V7_Cmd_S','bit_number',6},{'name','B3MB_100V7_Load4S','var_name','B3MB_100V7_Cmd_S','bit_number',7}});
dfs.plot('b3mb_b3mb_100v7_loadf','label','Fault','vars',{{'name','B3MB_100V7_Load1F','var_name','B3MB_100V7_Cmd_S','bit_number',12},{'name','B3MB_100V7_Load2F','var_name','B3MB_100V7_Cmd_S','bit_number',13},{'name','B3MB_100V7_Load3F','var_name','B3MB_100V7_Cmd_S','bit_number',14},{'name','B3MB_100V7_Load4F','var_name','B3MB_100V7_Cmd_S','bit_number',15}});
dfs.end_col;
dfs.start_col;
dfs.plot('b3mb_b3mb_100v8_batt', 'label', 'B3MB 100V8 Batt', 'plots', {'b3mb_b3mb_100v8_battvv','b3mb_b3mb_100v8_battav','b3mb_b3mb_100v8_batttv','b3mb_b3mb_100v8_batts','b3mb_b3mb_100v8_battf'});
dfs.plot('b3mb_b3mb_100v8_battvv','label','Volts 100V8','vars',{'B3MB_100V8_Batt1_V','B3MB_100V8_Bus_V'});
dfs.plot('b3mb_b3mb_100v8_battav','label','Amps 100V8','vars',{'B3MB_100V8_Batt1_I'});
dfs.plot('b3mb_b3mb_100v8_batttv','label','Temp 100V8','vars',{'B3MB_100V8_T1'});
dfs.plot('b3mb_b3mb_100v8_batts','label','Status','vars',{{'name','B3MB_100V8_B1S','var_name','B3MB_100V8_Cmd_S','bit_number',0},{'name','B3MB_100V8_Stat_LED','var_name','B3MB_100V8_LED_S','bit_number',0},{'name','B3MB_100V8_Fault_LED','var_name','B3MB_100V8_LED_S','bit_number',1},{'name','B3MB_100V8_ID_CPU','var_name','B3MB_100V8_LED_S','bit_number',2}});
dfs.plot('b3mb_b3mb_100v8_battf','label','Fault','vars',{{'name','B3MB_100V8_B1F','var_name','B3MB_100V8_Cmd_S','bit_number',8}});
dfs.plot('b3mb_b3mb_100v8_load', 'label', 'B3MB 100V8 Load', 'plots', {'b3mb_b3mb_100v8_loadvv','b3mb_b3mb_100v8_loadav','b3mb_b3mb_100v8_loads','b3mb_b3mb_100v8_loadf'});
dfs.plot('b3mb_b3mb_100v8_loadvv','label','Volts 100V8','vars',{'B3MB_100V8_Load1_V','B3MB_100V8_Load2_V','B3MB_100V8_Load3_V','B3MB_100V8_Load4_V'});
dfs.plot('b3mb_b3mb_100v8_loadav','label','Amps 100V8','vars',{'B3MB_100V8_Load1_I','B3MB_100V8_Load2_I','B3MB_100V8_Load3_I','B3MB_100V8_Load4_I'});
dfs.plot('b3mb_b3mb_100v8_loads','label','Status','vars',{{'name','B3MB_100V8_Load1S','var_name','B3MB_100V8_Cmd_S','bit_number',4},{'name','B3MB_100V8_Load2S','var_name','B3MB_100V8_Cmd_S','bit_number',5},{'name','B3MB_100V8_Load3S','var_name','B3MB_100V8_Cmd_S','bit_number',6},{'name','B3MB_100V8_Load4S','var_name','B3MB_100V8_Cmd_S','bit_number',7}});
dfs.plot('b3mb_b3mb_100v8_loadf','label','Fault','vars',{{'name','B3MB_100V8_Load1F','var_name','B3MB_100V8_Cmd_S','bit_number',12},{'name','B3MB_100V8_Load2F','var_name','B3MB_100V8_Cmd_S','bit_number',13},{'name','B3MB_100V8_Load3F','var_name','B3MB_100V8_Cmd_S','bit_number',14},{'name','B3MB_100V8_Load4F','var_name','B3MB_100V8_Cmd_S','bit_number',15}});
dfs.end_tab;
dfs.end_col;
