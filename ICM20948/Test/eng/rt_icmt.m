...
dfs.plot('icmp', 'label', 'ICM Peaks', 'plots', {'icmpf','icmpa'});
dfs.plot('icmpf','label','Freq','vars',{'ICM_peak_f_0_0','ICM_peak_f_0_1','ICM_peak_f_0_2'});
dfs.plot('icmpa','label','Amp','vars',{'ICM_peak_amp_0_0','ICM_peak_amp_0_1','ICM_peak_amp_0_2'});
dfs.end_col;
